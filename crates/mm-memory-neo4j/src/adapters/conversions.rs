...
mod tests {
    ...
    fn convert_date() {
        ...
        match bolt {
            BoltType::Date(date) => {
                let got: NaiveDate = date.try_into().unwrap();
                assert_eq!(got, d);
            }
    ...
    fn convert_time() {
        ...
        match bolt {
            BoltType::LocalTime(time) => {
                let got: NaiveTime = time.try_into().unwrap();
                assert_eq!(got, t);
            }
    ...
    fn convert_datetime() {
        ...
        match bolt {
            BoltType::DateTime(d) => {
                let got: DateTime<FixedOffset> = d.try_into().unwrap();
                assert_eq!(got, dt);
            }
    ...
    fn convert_local_datetime() {
        ...
        match bolt {
            BoltType::LocalDateTime(ldt) => {
                let got: NaiveDateTime = ldt.try_into().unwrap();
                assert_eq!(got, dt);
            }
